...
public class CattleComparator {
    ...
    public static Comparator<CattlePOJO> byBirthday = new Comparator<CattlePOJO>() {
        @Override
        public int compare(CattlePOJO o1, CattlePOJO o2) {
    ...
    public static Comparator<CattlePOJO> byBirthdayDesc = new Comparator<CattlePOJO>() {
        @Override
        public int compare(CattlePOJO o1, CattlePOJO o2) {
    ...
    public static Comparator<CattlePOJO> byWeight = new Comparator<CattlePOJO>() {
        @Override
        public int compare(CattlePOJO o1, CattlePOJO o2) {
